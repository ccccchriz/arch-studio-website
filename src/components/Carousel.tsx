...
export default function Carousel() {
  return (
    <div>
      ...
      <div className="min-h-[35rem] grid place-content-center bg-neutral-600 bg-opacity-60 bg-blend-overlay bg-cover px-8 text-neutral-100 bg-[url(/images/home/mobile/image-hero-paramour.jpg)] tablet:bg-[url(/images/home/tablet/image-hero-paramour.jpg)]  desktop:bg-[url(/images/home/desktop/image-hero-paramour.jpg)]">
